...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.label_score.config(fg="white")
        ...
        self.button_yes = Button(image=yes_image, highlightthickness=0, bg=THEME_COLOR, command=self.true_pressed)
        self.button_yes.grid(row=2, column=0)
        no_image = PhotoImage(file="./images/false.png")
        self.button_no = Button(image=no_image, highlightthickness=0, bg=THEME_COLOR, command=self.false_pressed)
